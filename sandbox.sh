...
main() {
  ...
  CONTAINER_ID=$(docker run -d \
    ...
    -v "$(pwd):/home/sandbox/workspaces/github.com/sandbox/examples.dotfiles" \
  ...
  timeout 2400 docker exec "$CONTAINER_ID" bash -c "cd workspaces/github.com/sandbox/examples.dotfiles && ./setup.sh" 2>&1
